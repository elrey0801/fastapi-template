...
class ErrorCode(Enum):
    BAD_REQUEST = ErrorInfo(4000, "Bad request", status.HTTP_400_BAD_REQUEST)
    INTERNAL_SERVER_ERROR = ErrorInfo(5000, "Internal server error", status.HTTP_500_INTERNAL_SERVER_ERROR)
    ...
    NO_FILE_UPLOADED = ErrorInfo(4009, "No file uploaded", status.HTTP_400_BAD_REQUEST)
    NO_IMAGE_AVAILABLE = ErrorInfo(4010, "No image available for this vocab", status.HTTP_404_NOT_FOUND)
